...
def generate_sorting_chart(csv_file, output_file='images/sorting_results.png'):
    ...
    ax1.set_title('Comparación de Tiempos de Ejecución de Algoritmos de Ordenamiento (Escala Logarítmica)')
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        generate_sorting_chart(sys.argv[1])
    else:
        print("Uso: python sorting_visualization.py archivo_resultados.csv")